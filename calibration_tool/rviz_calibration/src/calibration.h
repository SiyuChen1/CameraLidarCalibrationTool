...
public:
    ...
    void DistCorrectionCompressedImageCallbackFisheye(const sensor_msgs::CompressedImage::ConstPtr& msg);

    void DistCorrectionImageCallbackFisheye(const sensor_msgs::Image::ConstPtr& msg);
    ...
    // 读取当前修改后的 内参矩阵 和 投影矩阵
    void ReadCurrentParameter(QString parameter_path);
    ...
    void ImageApriltagsCallback(const sensor_msgs::Image::ConstPtr& image_rect);
...
private Q_SLOTS:
    ...
    void StartApriltagsNode(bool checked);
